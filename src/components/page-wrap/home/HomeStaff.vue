      ...
      <div class="container mx-auto relative z-10">
        <div class="staff">
            ...
            <div class="member flex flex-col-reverse lg:grid lg:grid-cols-staff gap-4">
              <div class="info-wrap">
                ...
                <div class="bio-wrap relative">
                  <div data-name="test1" class="info py-5">
                  ...
                  <div data-name="test2" class="info py-5" style="display: none;">
                  ...
                  <div data-name="test3" class="info py-5" style="display: none;">
              ...
              <div class="render-wrap relative">
                <div data-name="test1" class="render">
          ...
          <div class="pt-4 pb-6 flex lg:inline-flex mr-auto items-center justify-between flex-wrap text-gray-500">
            <div class="arrow arrow-left cursor-pointer order-2 transition-colors duration-150 ease-in-out hover:text-pink-400 lg:order-1 rounded-full">
            ...
            <div class="staffSelector w-full lg:w-auto pb-4 px-1 lg:pb-0 flex flex-wrap items-center justify-center order-1 lg:order-2 px-5">
              <div class="pr-1 relative transform transition duration-150 opacity-70 hover:opacity-80 cursor-pointer active hover:opacity-100 opacity-100 -translate-y-2">
              ...
              <div class="pr-1 relative transform transition duration-150 opacity-70 hover:opacity-80 cursor-pointer">
            ...
            <div class="arrow arrow-right cursor-pointer order-3 transition-colors duration-150 ease-in-out hover:text-pink-400 rounded-full">
              <svg fill="currentColor" viewBox="0 0 20 20" class="w-8 h-8">
